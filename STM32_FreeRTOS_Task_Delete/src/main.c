...
char usr_msg[250];
void led_task1_handler(void *params);
void button_task2_handler(void *params);
...
int main(void)
{
	...
	xTaskCreate(led_task1_handler,"LED-TASK",configMINIMAL_STACK_SIZE,NULL,1,NULL);

	//lets create button_task
	xTaskCreate(button_task2_handler,"LED-TASK",configMINIMAL_STACK_SIZE,NULL,1,NULL);
...
//			printf(usr_msg);
			sprintf(usr_msg,"Eliminando Task-2\r\n");
			printmsg(usr_msg);
			vTaskDelete(NULL);
